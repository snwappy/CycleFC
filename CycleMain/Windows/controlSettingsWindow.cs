...
namespace CycleMain
{
    public partial class controlSettingsWindow : Form
    {
        bool _Ok = false;
        public bool OK
        ...
        {
            keysetupWindow kk = new keysetupWindow("Player1 Left");
            kk.ShowDialog();
            if (kk.OK)
            {
        ...
        {
            keysetupWindow kk = new keysetupWindow("Player1 Right");
            kk.ShowDialog();
            if (kk.OK)
            {
        ...
        {
            keysetupWindow kk = new keysetupWindow("Player1 Up");
            kk.ShowDialog();
            if (kk.OK)
            {
        ...
        {
            keysetupWindow kk = new keysetupWindow("Player1 Down");
            kk.ShowDialog();
            if (kk.OK)
            {
        ...
        {
            keysetupWindow kk = new keysetupWindow("Player1 A");
            kk.ShowDialog();
            if (kk.OK)
            {
        ...
        {
            keysetupWindow kk = new keysetupWindow("Player1 B");
            kk.ShowDialog();
            if (kk.OK)
            {
        ...
        {
            keysetupWindow kk = new keysetupWindow("Player1 Start");
            kk.ShowDialog();
            if (kk.OK)
            {
        ...
        {
            keysetupWindow kk = new keysetupWindow("Player1 Select");
            kk.ShowDialog();
            if (kk.OK)
            {
        ...
        {
            keysetupWindow kk = new keysetupWindow("Player2 Left");
            kk.ShowDialog();
            if (kk.OK)
            {
        ...
        {
            keysetupWindow kk = new keysetupWindow("Player2 Right");
            kk.ShowDialog();
            if (kk.OK)
            {
        ...
        {
            keysetupWindow kk = new keysetupWindow("Player2 Up");
            kk.ShowDialog();
            if (kk.OK)
            {
        ...
        {
            keysetupWindow kk = new keysetupWindow("Player2 Down");
            kk.ShowDialog();
            if (kk.OK)
            {
        ...
        {
            keysetupWindow kk = new keysetupWindow("Player2 A");
            kk.ShowDialog();
            if (kk.OK)
            {
        ...
        {
            keysetupWindow kk = new keysetupWindow("Player2 B");
            kk.ShowDialog();
            if (kk.OK)
            {
        ...
        {
            keysetupWindow kk = new keysetupWindow("Player2 Start");
            kk.ShowDialog();
            if (kk.OK)
            {
        ...
        {
            keysetupWindow kk = new keysetupWindow("Player2 Select");
            kk.ShowDialog();
            if (kk.OK)
            {
        ...
        {
            profileNameWindow nam = new profileNameWindow();
            nam.ShowDialog(this);
            if (nam.OK)
            {
